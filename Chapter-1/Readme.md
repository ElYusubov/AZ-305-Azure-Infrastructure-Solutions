...
- [What is Kubernetes?](https://azure.microsoft.com/en-us/topic/what-is-kubernetes/?WT.mc_id=AZ-MVP-5004750#overview)
- [Azure Kubernetes Service](https://docs.microsoft.com/en-us/azure/aks/intro-kubernetes?WT.mc_id=AZ-MVP-5004750)
- [Azure Function best practices](https://docs.microsoft.com/en-us/azure/azure-functions/functions-best-practices?tabs=csharp&WT.mc_id=AZ-MVP-5004750)
- [Cost Center Tagging Serverless Automation](https://github.com/mspnp/serverless-automation/blob/main/src/automation/cost-center/deployment.md)
